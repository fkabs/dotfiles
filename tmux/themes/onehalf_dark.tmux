...
setf() {
   local option=$1
   local value=$2
   tmux set-option -Fg "$option" "$value"
}
...
set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets} #[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#{?pane_in_mode,#[fg=$onedark_black]#[bg=$onedark_yellow] <MODE> ,}#[fg=$onedark_red,bg=$onedark_yellow]#{?client_prefix,#[fg=$onedark_black]#[bg=$onedark_red] <Leader> ,}"
