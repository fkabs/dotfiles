...
Describe the project structure so OpenCode understands where things live.
...
List important files that OpenCode should know about.
...
4. **Be useful**: Would this help a new OpenCode session understand the project?
